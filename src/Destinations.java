...
public class Destinations extends JFrame implements Runnable{
    ...
    Thread t1;
    public void run(){
        String[] text=new String[]{"Manali","Ladakh","Jaipur","Andaman Islands","Bombay","Assam","Meghalaya","Kathmandu","Sikkim","Delhi"};
        try{
            for(int i=0;i<10;i++){
    ...
    Destinations() {
        ...
        for (int i = 0; i < 10; i++) {
            i_image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/dest " + (i + 1) + ".jpg"));//dest
